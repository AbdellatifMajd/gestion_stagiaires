...
return [
    ...
    */
    ...
    'logo' => 'CTT Managem Group ',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Managem Guemassa',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'listes des stagiaires',
                    'url' => 'admin/stagiaires',
                    'icon' => 'fas fa-fw fa-list',
                ],
                [
                    'text' => 'ajouter un stagiaire',
                    'url' => 'admin/stagiaires/create',
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'https://cdn.jsdelivr.net/npm/sweetalert2@11.10.7/dist/sweetalert2.all.min.js',
                ],
            ],
        ],
        'Pace' => [
